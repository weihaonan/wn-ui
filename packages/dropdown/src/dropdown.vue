    ...
    render(h) {
      ...
      if (splitButton) {
        ...
        triggerElm = <el-button-group>
          <dbsec-button type={type} size={dropdownSize} nativeOn-click={handleMainButtonClick} disabled={disabled}>
            {this.$slots.default}
          </dbsec-button>
          <dbsec-button ref="trigger" type={type} size={dropdownSize} class="el-dropdown__caret-button" disabled={disabled}>
