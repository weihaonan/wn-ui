...
<template>
  <div class="headerWrapper">
    ...
    <header class="header" ref="header" style="background-color: #f08300;">
      <div class="container">
        <h1><router-link :to="`/${ lang }`">
          ...
          <slot>
            <img
              ...
              class="nav-logo">
            <img
              src="../assets/images/DBSEC-logo.png"
              alt="element-logo"
...
<script>
  ...
  import logoImg from '../assets/images/DBSEC-logo.png';
  ...
  export default {
    ...
    created() {
      ...
      xhr.send();
      let primaryLast = '#f08300';
      bus.$on(ACTION_USER_CONFIG_UPDATE, (val) => {
        let primaryColor = val.global['$--color-primary'];
        if (!primaryColor) primaryColor = '#f08300';
